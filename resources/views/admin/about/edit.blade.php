...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('seo_title', old('seo_title',$about->seo_title), array('class'=>'form-control')) !!}

    </div>
</div><div class="form-group">
    {!! Form::label('seo_keywords', 'SEO Keywords', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('seo_keywords', old('seo_keywords',$about->seo_keywords), array('class'=>'form-control')) !!}

    </div>
</div><div class="form-group">
    {!! Form::label('seo_description', 'SEO Description', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::textarea('seo_description', old('seo_description',$about->seo_description), array('class'=>'form-control')) !!}
